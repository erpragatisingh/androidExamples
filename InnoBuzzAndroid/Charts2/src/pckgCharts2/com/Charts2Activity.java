...
public class Charts2Activity extends Activity {
    ...
    public static void  draw_the_grid(Canvas this_g,  Vector these_labels)
     {
       ...
       this_g.drawRect(drawSizes[0], drawSizes[1],drawSizes[0]+ drawSizes[2],
           ...
           for(int i=1; i < 5 ; i++)
           {
               ...
               this_g.drawLine(drawSizes[0], drawSizes[1] + (i * drawSizes[3] / 5), 
            		   drawSizes[0] + drawSizes[2], drawSizes[1] + (i * drawSizes[3] / 5), paint);
               this_g.drawLine(drawSizes[0]+ (i * drawSizes[2] / 5), drawSizes[1],
            		   drawSizes[0] + (i * drawSizes[2] / 5), drawSizes[1] + drawSizes[3], paint);

           }


          // good for one value
           print_axis_values_4_grid(this_g, cur_elt_array[1] , Double.toString(rounded_max) , 
        		   Double.toString(rounded_min), cur_elt_array[0] , 2 ,0 );
    ...
    public static void print_axis_values_4_grid(Canvas thisDrawingArea, String cur_units ,
    		String cur_max , String cur_min , String cur_label , int  x_guide , int  this_idx )
    {
          String this_str;
